...
urlpatterns = patterns('tupa.views',
        ...
        (r'^(?P<kisa_nimi>[^/]+)/tulosta_?(?P<tulostyyppi>[^/]*)/$', 'tulosta'),
        (r'^(?P<kisa_nimi>[^/]+)/tulosta/tilanne/$', 'laskennanTilanne'),
		(r'^(?P<kisa_nimi>[^/]+)/tulosta/sarja/heijasta/(?P<sarja_id>\d+)/$', 'heijasta'),
		(r'^(?P<kisa_nimi>[^/]+)/tulosta/sarja/heijasta/$', 'heijasta'),
