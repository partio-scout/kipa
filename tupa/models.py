...
class Tehtava(models.Model):
    ...
    def mukanaOlevatVartiot(self):
        """
        Palauttaa listan Vartioista jotka
        ovat mukana tehtavan interpoloinneissa.
        """
        ...
        if vartiot:
            for v in vartiot:
                laskennassa = True
                if v.ulkopuolella is not None:
                    if self.jarjestysnro >= v.ulkopuolella:
                        laskennassa = False
                if v.keskeyttanyt is not None:
...
class OsaTehtava(models.Model):
        ...
        def __unicode__(self):
                ...
                sarja = tehtava.sarja
                kisa = sarja.kisa
                return (kisa.nimi + "." + sarja.nimi + "." +
                        tehtava.nimi + "." + self.nimi)
...
class SyoteMaarite(models.Model):
    TYYPPI_VAIHTOEHDOT = (('aika', 'aika'), ('piste', 'piste'))
    ...
    def __unicode__(self):
        ...
        kisa = sarja.kisa
        return (kisa.nimi + "." + sarja.nimi + "." +
                tehtava.nimi + "." + ot.nimi + "." + self.nimi)
...
class Syote(models.Model):
    ...
    def __unicode__(self):
        ...
        sarja = tehtava.sarja
        kisa = sarja.kisa
        return (kisa.nimi + "." + sarja.nimi + "." + tehtava.nimi +
                "." + ot.nimi + "." + maarite.nimi + "." + str(vartio.nro))
